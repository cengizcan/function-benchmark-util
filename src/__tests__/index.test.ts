import { benchmarkTimesWithThis, benchmarkWithThis, benchmark, benchmarkTimes, convertTimeToMilliseconds } from '../index';
...
describe('function-benchmark-util tests', () => {
  ...
  it('test microseconds to milliseconds conversion', () => {
    const response = convertTimeToMilliseconds({functionName: 'fnName', min: 0, average: 124.689, max: 12000, runCount: 987, fnReturns: 'return-value'}, 3);
